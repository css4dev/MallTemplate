...
public class AdapterNewProducts extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private final List<Product> items;
    private AdapterNewProducts.OnItemClickListener onItemClickListener;
    Context context;
    ...
    public void setOnItemClickListener(AdapterNewProducts.OnItemClickListener onItemClickListener) {
    ...
    public AdapterNewProducts(List<Product> items, Context context) {
        this.items = items;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        vh = new AdapterNewProducts.ViewHolder(v);
        return vh;
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof AdapterNewProducts.ViewHolder) {
            AdapterNewProducts.ViewHolder vItem = (AdapterNewProducts.ViewHolder) holder;
